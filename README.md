...
php artisan make:model Kolam -m
php artisan make:filament-resource Kolam
php artisan make:factory PakanFactory  
 
  
#### **Tabel `StokPakan`**

```bash
php artisan make:model StokPakan -m
```

#### **Tabel `PenjualanIkan`**

```bash
php artisan make:model PenjualanIkan -m
```

#### **Tabel `TransaksiKeuangan`**

```bash
php artisan make:model TransaksiKeuangan -m
```

#### **Tabel `Fcr`**

```bash
php artisan make:model Fcr -m
```
...
#### **Filament Resource `StokPakan`**

```bash
php artisan make:filament-resource StokPakan
```

#### **Filament Resource `PenjualanIkan`**

```bash
php artisan make:filament-resource PenjualanIkan
```

#### **Filament Resource `TransaksiKeuangan`**

```bash
php artisan make:filament-resource TransaksiKeuangan
```

#### **Filament Resource `Fcr`**

```bash
php artisan make:filament-resource Fcr
```
...
#### **Factory `StokPakanFactory`**

```bash
php artisan make:factory StokPakanFactory --model=StokPakan
```

#### **Factory `PenjualanIkanFactory`**

```bash
php artisan make:factory PenjualanIkanFactory --model=PenjualanIkan
```

#### **Factory `TransaksiKeuanganFactory`**

```bash
php artisan make:factory TransaksiKeuanganFactory --model=TransaksiKeuangan
```

#### **Factory `FcrFactory`**

```bash
php artisan make:factory FcrFactory --model=Fcr
```

---

Dengan perintah-perintah di atas, kamu dapat menghasilkan model, migrasi, Filament Resource, dan factory untuk setiap tabel yang diperlukan dalam aplikasi **manajemen kolam ikan**. Setelah menjalankan perintah ini, kamu bisa melanjutkan dengan **mengedit migrasi** dan **resource** sesuai dengan kebutuhan aplikasi.
